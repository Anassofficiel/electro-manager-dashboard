  ...
  return (
    <Sidebar className="border-r border-border/50 bg-sidebar/50 backdrop-blur-xl">
      <SidebarContent>
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="text-xs font-medium text-muted-foreground mb-2">Main Menu</SidebarGroupLabel>
          <SidebarMenu>
            {menuItems.map((item) => {
        ...
        <SidebarGroup className="mt-auto">
           <SidebarGroupLabel className="text-xs font-medium text-muted-foreground mb-2">Preferences</SidebarGroupLabel>
           <SidebarMenu>
